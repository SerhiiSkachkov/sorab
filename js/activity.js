    ...
    return [
        {
            ...
            svg: '<svg class="crowdsorsing" width="39" height="186" viewBox="0 0 39 186"><path fill="#FFF" stroke="#000" stroke-opacity=".147" d="M3 1a2 2 0 0 1 2 2v182H1V3a2 2 0 0 1 2-2z"/><path class="flag-top" fill="#31C966" d="M1 15l38 20.036L1 53z"/></svg>'
        },
        {
            id: 2,
            title: "Catalyst 1",
            ...
            svg: '<svg class="crowdfounding" width="39" height="186" viewBox="0 0 39 186"><g fill="none" fill-rule="evenodd"><path fill="#FFF" stroke="#000" stroke-opacity=".147" d="M3 1a2 2 0 0 1 2 2v182H1V3a2 2 0 0 1 2-2z"/><path class="flag-top" fill="#31C966" d="M1 15l38 20.036L1 53z"/></g></svg>'
        },
        {
            id: 3,
            title: "Catalyst A",
        ...
        },
        {
            ...
            notes: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.",
                        svg: '<svg class="crowdfounding" width="39" height="186" viewBox="0 0 39 186"><path fill="#FFF" stroke="#000" stroke-opacity=".147" d="M3 1a2 2 0 0 1 2 2v182H1V3a2 2 0 0 1 2-2z"/><path class="flag-top" fill="#31C966" d="M1 15l38 20.036L1 53z"/></svg>'
